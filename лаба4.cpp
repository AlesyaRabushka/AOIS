...
int main()
{
	...
	cout << "Di СКНФ: ";// << sdnf_Di << endl;
	cout << "(x1+x2+x3)*(x1+!x2+!x3)*(!x1+x2+!x3)*(!x1+!x2+x3)" << endl;
	cout << "Bi1 СКНФ: ";// << sdnf_Bi1 << endl;
	cout << "(x1+x2+x3)*(x1+x2+!x3)*(x1+!x2+x3)*(!x1+x2+x3)" << endl;

	cout << endl << "Di ткнф: ";// << dead_end(glued(sdnf_Di)) << endl;
	cout << "(x1+x2+x3)*(x1+!x2+!x3)*(!x1+x2+!x3)*(!x1+!x2+x3)" << endl;
	cout << "Bi+1 ткнф: ";// << dead_end(glued(sdnf_Bi1)) << endl << endl;
	cout << "(x2+x3)*(x1+x2)*(x1+x3)" << endl;
	...
	cout << endl;
	cout << "y4: !x4" << endl;
	cout << "y3: !x4*x3+!x4*x2*x1" << endl;
	cout << "y2: !x4*!x2*x1+!x4*x2*!x1" << endl;
	cout << "y1: !x4*!x1" << endl;
	cout << "" << endl;
